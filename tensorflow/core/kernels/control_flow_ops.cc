...
#ifdef TENSORFLOW_USE_SYCL
TF_CALL_SYCL_REAL_NUMBER_TYPES_NO_INT32(REGISTER_SYCL_SWITCH);
TF_CALL_SYCL_REAL_NUMBER_TYPES_NO_INT32(REGISTER_SYCL_REF_SWITCH);
#endif // TENSORFLOW_USE_SYCL
...
TF_CALL_SYCL_REAL_NUMBER_TYPES_NO_INT32(REGISTER_SYCL_REF_KERNEL);
